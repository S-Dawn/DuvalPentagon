...
public class Coordinates {
    ...
    {
        Coordinates polygon1[] = { new Coordinates(0, 0), new Coordinates(10, 0),
                new Coordinates(10, 10), new Coordinates(0, 10) };
        int n = 4;
        ...
        Coordinates polygon3[] = { new Coordinates(0, 0), new Coordinates(10, 0),
                new Coordinates(10, 10), new Coordinates(0, 10), new Coordinates(5, 5) };
        n = 5;
